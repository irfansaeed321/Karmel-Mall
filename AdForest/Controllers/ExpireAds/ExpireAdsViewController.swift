...
class ExpireAdsViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, NVActivityIndicatorViewable , selectedPopUpValueProtocol,UISearchBarDelegate,NearBySearchDelegate,UIGestureRecognizerDelegate {
