...
class MessagesController: ButtonBarPagerTabStripViewController, NVActivityIndicatorViewable, UISearchBarDelegate,NearBySearchDelegate,UIGestureRecognizerDelegate {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let sentOffers = SB.instantiateViewController(withIdentifier: SentOffersController.className) as! SentOffersController
        let addsOffer = SB.instantiateViewController(withIdentifier: OffersOnAdsController.className) as! OffersOnAdsController
        let blockedController = SB.instantiateViewController(withIdentifier: BlockedUserChatViewController.className) as! BlockedUserChatViewController
