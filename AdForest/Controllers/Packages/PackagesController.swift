            ...
            for ob in objData.allow_cats_valArr{
                if let catName = ob.cat_name{
                    ...
                    let strokeTextAttributes: [NSAttributedString.Key: Any] = [
                        ...
                        NSAttributedString.Key.underlineColor: UIColor(hex: bgColor!)
                        //.font : UIFont.boldSystemFont(ofSize: 18)
                    ]
            let underlineAttributedString = NSAttributedString(string: objData.seeAll, attributes: strokeTextAttributes)
                    let yourAttributes = [NSAttributedString.Key.foregroundColor: UIColor.black, NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14)]
