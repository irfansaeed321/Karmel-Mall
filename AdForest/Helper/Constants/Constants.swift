...
class Constants {
    struct URL {
        ...
        static let ipAddress =  "https://karmelmall.net/"//Enter your Domain Url here
    ...
    struct customCodes {
        static let purchaseCode = "7cbd9604-3a74-4a0e-b11f-50bf18511a34"
        static let securityCode = "123"
    }
